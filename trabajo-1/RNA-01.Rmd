...
if (!is.null(resultado_ga)) {
 ...
 tryCatch({
      ...
      caption_text <- "Figura 2: Evolución del mejor fitness (verde) y fitness promedio (azul) por generación."
...
if(exists("all_segments_history_ga") && nrow(all_segments_history_ga) > 0 && exists("colombia")) {
    ...
    animacion_proceso_ga <- mapa_base_historia_ga +
      ...
      labs(
        ...
        caption = "Figura 3: Proceso de optimización ACO(Fuente: Elaboración propia, 2025)", 
...
La animación resultante (**Figura 3**) ilustra cómo la mejor ruta encontrada por el algoritmo AG evoluciona a lo largo de las iteraciones, tendiendo a estabilizarse a medida que el algoritmo converge hacia una solución de bajo costo.
